                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <form action="index.php" method="post" class="tm-login-form">
                                ...
                                <div class="input-group mt-3">
                                    <button type="submit" class="btn btn-primary d-inline-block mx-auto"><a href="index.php"></a>Login</button>
                                </div>
                                   <?php
                                   ...
                                   $username=$_POST['username'];
                                    ...
                                    $result=mysqli_query($conn,"SELECT * FROM admin login where username='$username'and password='$password' ");
