                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                <h2 class="tm-block-title d-inline-block"> Application for Leave</h2>
                                ...
                                <thead>
                                    <tr class="tm-bg-gray">
                                       ...
                                       <!-- <th scope="col">Event Id</th>-->
                                        ...
                                        <th scope="col" class="text-center">Leave Date from</th>
                                        <th scope="col" class="text-center">Leave Date end</th>
                                                ...
                                                while($row=$result->fetch_array())
                                                {
                                                   ...
                                                   // $address=$row['address'];
                                                    ...
                                                    ?>
                                                     ...
                                                     <tr>
                                                        <th scope="col">&nbsp;</th>
                                                        <td class="tm-product-name"><?php echo $registration_id;?></td>
                                                        <td class="text-center"><?php echo $date_start;?></td>
                                                        <td class="text-center"><?php echo $date_end;?></td>
                                                        <td><input type="button" value="CONFRIM" onclick="checktask()"></input></td> 
                                                        <th scope="col">&nbsp;</th>
                                                     </tr>
                                                   <?php
                                ...
                                ?>
                                 <script type="text/javascript">
                                            function checktask(){
                                                ...
                                                $query="UPDATE `leave` SET `status`='accepted' where registration_id='$registration_id'";
