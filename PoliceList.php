                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                <h2 class="tm-block-title d-inline-block">Police List</h2>
                                       ...
                                       include_once('config.php');
                                           ...
                                           if($run->num_rows!=0)
                                           {
                                             ...
                                             while($row=$run->fetch_array())
                                             {
                                                ...
                                                <td class="tm-product-name"><?php echo $mobile_no;?></td>
                                                <td class="tm-product-name"><?php echo $email_id;?></td>
                                                <td class="tm-product-name"><?php echo $address;?></td>
