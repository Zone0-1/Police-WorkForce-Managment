                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                <h2 class="tm-block-title d-inline-block"> Application for Leave</h2><br>
                                 <button type="button"  >
                                    <a href="Leave.php">
                                    View
                                    </a>
                            ...
                            <br>
                          <!--   <div class="col-md-8 col-sm-12">
                                <h2 class="tm-block-title d-inline-block">  Volunters for Events:</h2><br>
                                 <button type="button"  >
                                    <a href="Volunters.php">
                                    View
                                    </a>
                                </button>
