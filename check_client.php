                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                <h2 class="tm-block-title d-inline-block"> Leave Status:</h2>
                             <!--   <button type="button" >
                                    Add Event
                                </button>-->
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                ...
                                <tbody>
                                    <?php
                                          include_once('config.php');
                                          $querry="SELECT * FROM `leave` WHERE  registration_id='".$_SESSION['registration_id']."' ";
                                         ...
                                         ?>
                                                     ...
                                                     <tr>
                                                     <th scope="col">&nbsp;</th>
                                                    <td class="tm-product-name"><?php echo $date_start?></td>
