                            ...
                            <table class="table table-hover table-striped tm-table-striped-even mt-3">
                                <thead>
                                    <tr class="tm-bg-gray">
                                       ...
                                       <!-- <th scope="col" class="text-center"></th>
                                        <th scope="col" class="text-center">Police Id</th>-->
                                        <th scope="col">Status of Task</th>
                                ...
                                <tbody>
                                    <?php
                                         ...
                                         $query="SELECT * from tasks where registration_id='".$_SESSION['registration_id']."' ";
                                         //echo $reg_id;
                                        ...
                                        if($result->num_rows!=0)
                                        {
                                            while($row=$result->fetch_array())
                                            {
                                             ...
                                             ?>
                                                ...
                                                <tr>
                                                     <th scope="col">&nbsp;</th>
                                                    <!-- <td class="tm-product-name"><?php echo $task_id;?></td>-->
                                                    <td class="tm-product-name"><?php echo $task_name;?></td>
                                                    <td class="tm-product-name"><?php echo $descryption;?></td>
                                                    <td class="tm-product-name"><?php echo $status;?></td>
                                                    <td><input type="button" value="UPDATE" onclick="checktask()"></input></td> 
                                                     <th scope="col">&nbsp;</th>
                                    ...
                                    <script type="text/javascript">
                                            function checktask(){
                                                ...
                                                <?php
                                                    ...
                                                    include_once('config.php');
                                                    //$reg_id=$_SESSION['registration_id'];
                                                $query="UPDATE `tasks` SET `status`='complete' where task_id='$task_id'";
                                                     $result=mysqli_query($conn,$query);
                                                     if ($result==TRUE) {
